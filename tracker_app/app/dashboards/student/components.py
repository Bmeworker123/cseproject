...
def render_page_header(parent, title, subtitle):
    Label(parent, text=title, size=16, bold=True, bg="white", fg="#1f2933").pack(anchor="w")
    Label(parent, text=subtitle, size=10, bg="white", fg="#52606d").pack(anchor="w", pady=6)
...
def render_empty_state(parent, title, message, *, bg, title_fg, message_fg):
    ...
    Label(empty, text=message, size=10, bg=bg, fg=message_fg, wraplength=760, justify="left").pack(anchor="w", pady=(6, 0))
    return empty
